...
namespace Vuplex.WebView {
    ...
    /// <summary>
    /// An interface implemented by a webview if it supports a version of `HandleKeyboardInput`
    /// that accepts key modifiers, which can be used to trigger keyboard shortcuts.
    /// </summary>
