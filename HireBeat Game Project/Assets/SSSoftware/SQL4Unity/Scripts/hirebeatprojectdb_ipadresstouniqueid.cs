...
public partial class hirebeatprojectdb_ipadresstouniqueid: SQL4Unity.SQLRow {
public new ushort rowId { get { return Get<ushort>(27); } }
public string IPAddress { get { return Get<string>(29); } set { Set(29, value); } }
public string UniqueID { get { return Get<string>(30); } set { Set(30, value); } }
/// <summary>
